<template>
  <section class="text-white mt-20" id="contact">
    ...
    >
      <!-- Contact Info -->
      <div>
        <p class="text-[#adb7be] mb-10">
          Feel free to reach out — I’m open to collaborations, projects, and new
          opportunities.
        </p>
        ...
        <div class="flex mb-10 items-center">
          ...
          <div class="ml-5 text-white">
            <h4>LinkedIn</h4>
            <a
              class="text-white font-semibold hover:text-primary hover:underline transition-colors duration-300"
              href="https://www.linkedin.com/in/mohamed-houfani-941147323"
              target="_blank"
              rel="noopener noreferrer"
            >
              Mohammed-Elamine-Houfani
            </a>
          </div>
        </div>
      </div>
      ...
      >
        <form class="flex flex-col p-4" data-aos="zoom-in-up">
          ...
          <button
            type="submit"
            class="z-10 w-full sm:w-max px-6 md:px-7 py-3 rounded-full sm:w-max flex justify-center text-white bg-primary border-2 border-transparent"
          >
            Send Message
          </button>
        </form>
