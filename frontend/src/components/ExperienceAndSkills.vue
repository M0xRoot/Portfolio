<template>
    <section
     class="text-white mt-[4.5rem]" id="skills"
    >
        <div
         class="absolute right-0 top-[110rem] h-full w-full justify-end"
        >
            <span
        ...
        >
            ...
            >
                ...
                <div
                 class="mt-8 last:pb-14"
                 v-for="skill in skills"
                 :key="skill.id"
                >
                    <div
                     class="flex items-end justify-between" data-aos="fade-right"
                    >
                        <h4
                    ...
                    <div
                     class="mt-2 h-1 w-full bg-[#131d30] rounded-full"
                    >
                        <div
                         class="h-1 rounded-full bg-primary transition-all duration-5000 ease-out"
...
<script setup>
    ...
    const skills = ref([
    { id:1, name:'HTML & CSS', width:'85%', currentWidth:'0%' },
    { id:2, name:'Python', width:'70%', currentWidth:'0%' },
    { id:3, name:'JavaScript', width:'80%', currentWidth:'0%' },
    ...
    const experiences = ref([
        { id:1, role:'Web Development and Security', company:'Originova', date:'January 2025 - Now'},
        { id:2, role:'App Development and Production', company:'Originova', date:'June 2025 - November 2025'},
    ])

    onMounted(() => {
        skills.value.forEach((skill, i) => {
            setTimeout(() =>{
                skill.currentWidth = skill.width
            }, i * 150)
        })
    })
</script>